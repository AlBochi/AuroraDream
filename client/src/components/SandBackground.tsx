...
export default function SandBackground() {
  ...
  useEffect(() => {
    ...
    const drawBackground = () => {
      ...
      // 2. Northern lights layers
      const layers = [
        { 
          color: "rgba(0, 255, 136, 0.35)", // Emerald green
          speed: 0.000015,
          amplitude: 60, 
          yOffset: 0.2,
          frequency: 0.001
        ...
        { 
          color: "rgba(128, 0, 255, 0.28)", // Purple
          speed: 0.000012,
          amplitude: 80, 
          yOffset: 0.25,
          frequency: 0.0008
        ...
        { 
          color: "rgba(0, 200, 255, 0.22)", // Cyan
          speed: 0.00002,
          amplitude: 100, 
          yOffset: 0.3,
          frequency: 0.0012
        ...
        { 
          color: "rgba(255, 100, 200, 0.18)", // Pink
          speed: 0.00001,
          amplitude: 70, 
          yOffset: 0.35,
          frequency: 0.0009
        ...
        { 
          color: "rgba(100, 220, 255, 0.15)", // Light blue
          speed: 0.000018,
          amplitude: 90, 
          yOffset: 0.4,
          frequency: 0.0011
