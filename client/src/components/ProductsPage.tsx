  ...
  return (
    <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
      <div className="text-center">
        <p className="text-blue-700 font-medium">For pricing information:</p>
        <a href="tel:+16132900212" className="block mt-2 text-blue-600 hover:text-blue-800 font-semibold">
          📞 Call (613) 290-0212
        </a>
        <p className="text-sm text-gray-600 mt-2">Includes free Ottawa delivery</p>
        <a 
