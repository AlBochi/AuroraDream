    ...
    <footer className="bg-gradient-to-b from-[#0A3A57] to-[#0d2b42] text-[#F3E8D0] py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                <Mail size={18} />
                <a href="mailto:info@auroradream.ca" className="hover:text-[#3A7BF7] transition-colors">
                  info@auroradream.ca
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Phone size={18} />
                <a href="tel:+16132900212" className="hover:text-[#3A7BF7] transition-colors">
                  +1 (613) 290-0212
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <p className="mb-4">Stay connected for sleep tips and updates</p>
        ...
        <div className="border-t border-white/20 mt-8 pt-6 text-center">
          <p>&copy; {new Date().getFullYear()} Aurora Dream. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
