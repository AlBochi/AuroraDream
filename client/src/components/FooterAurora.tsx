    ...
    <footer className="bg-gradient-to-b from-[#0A3A57] to-[#0d2b42] text-[#F3E8D0] py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div><h3 className="text-xl font-light mb-4">Follow Us</h3><p className="mb-4">Stay connected</p><div className="flex items-center gap-3 flex-wrap">
            ...
            <button onClick={handleInstagramClick} className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#F56040]/20 hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#F56040]/40 text-[#F3E8D0] transition-all duration-300" aria-label="Instagram"><Instagram className="w-5 h-5" /></button>
            <button onClick={handleYouTubeClick} className="flex items-center justify-center w-10 h-10 rounded-full bg-[#FF0000]/20 hover:bg-[#FF0000]/40 text-[#F3E8D0] transition-all duration-300" aria-label="YouTube"><Youtube className="w-5 h-5" /></button>
            <button onClick={handleTwitterClick} className="flex items-center justify-center w-10 h-10 rounded-full bg-black/20 hover:bg-black/40 text-[#F3E8D0] transition-all duration-300" aria-label="X (Twitter)"><Twitter className="w-5 h-5" /></button>
            <button onClick={handleThreadsClick} className="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-[#000000] via-[#333333] to-[#666666]/20 hover:from-[#000000] hover:via-[#333333] hover:to-[#666666]/40 text-[#F3E8D0] transition-all duration-300" aria-label="Threads"><MessageSquare className="w-5 h-5" /></button>
            <button onClick={handleLinkedInClick} className="flex items-center justify-center w-10 h-10 rounded-full bg-[#0A66C2]/20 hover:bg-[#0A66C2]/40 text-[#F3E8D0] transition-all duration-300" aria-label="LinkedIn"><Linkedin className="w-5 h-5" /></button></div></div>
