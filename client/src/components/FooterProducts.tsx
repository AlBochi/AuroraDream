    ...
    <footer className="bg-white text-gray-800 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div><h3 className="text-xl font-semibold mb-4">Follow Us</h3><p className="mb-4 text-gray-600">Stay connected</p><div className="flex items-center gap-4">
            ...
            <button onClick={handleInstagramClick} className="flex items-center justify-center w-10 h-10 rounded-full bg-pink-100 hover:bg-pink-200 text-pink-600 transition-all duration-300" aria-label="Instagram"><Instagram className="w-5 h-5" /></button></div></div>
