      ...
      <div className="relative">
        ...
        >
          <div className="flex items-center">
            ...
            <span className="ml-4 text-[#3A7BF7]">Select</span>
          </div>
          ...
          <div className="absolute z-10 w-full mt-1 bg-[#0A3A57] border border-[#3A7BF7]/30 rounded-lg shadow-lg overflow-hidden">
            {prices.map((priceItem, index) => (
              ...
              >
                ...
                <span className="text-[#3A7BF7] font-semibold">Available</span>
              </button>
            ))}
          </div>
        )}
  ...
  <div className="p-6 bg-gradient-to-br from-blue-900/30 to-blue-800/20 rounded-xl border border-blue-500/30">
    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="text-center md:text-left">
        <h3 className="text-xl font-semibold text-white mb-2">Personalized Pricing Available</h3>
        <p className="text-blue-100">
          Includes free Ottawa delivery & 10-year warranty
        </p>
      </div>
...
>
  📞 Call Now
        ...
        <a 
          ...
          className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold rounded-lg transition-all shadow-lg min-w-[180px]"
        >
          📅 Book Consultation
        </a>
      </div>
  ...
  <div className="text-center">
    <p className="text-blue-300 text-sm">
      Available in 5 sizes • Free setup included
    </p>
  </div>
</div>
                </div>
          ...
          {/* All Sizes Available Table - Only for products with prices */}
          {product.prices && selectedSize && (
            <div className="bg-[#0A3A57]/30 rounded-2xl p-8 backdrop-blur-sm">
              <h2 className="text-2xl font-light text-[#F3E8D0] mb-6">All Sizes Available</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {product.prices.map((priceItem, index) => (
                  ...
                  >
                    ...
                    <div className="text-xl font-bold text-[#3A7BF7]">Available</div>
                    {selectedSize?.size === priceItem.size && (
